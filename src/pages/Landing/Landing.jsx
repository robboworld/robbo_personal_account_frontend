...
/** Логотип в шапке — тот же файл, что на scratch.example.com (статика). */
const SCRATCH_RU_HEADER_LOGO_URL =
  'https://scratch.example.com/static/assets/5cfab8ad77067bdc0fa535ef6a992491.svg'
      ...
      <PageRoot data-theme={dark ? 'dark' : 'light'}>
        <MotionHeaderBar {...headerMotion}>
          <NavCluster>
            ...
            <Button
              type='primary'
              href='https://scratch.example.com'
              target='_blank'
              rel='noreferrer'
            >
              Создавать
          ...
          <MotionSection {...sectionReveal}>
            ...
            <CopyCard>
              ...
              <div style={{ marginBottom: 10 }}>
                ...
                — переход на нынешний scratch.example.com
              </div>
              <div style={{ marginBottom: 10 }}>
