...
const LMS_COURSE_EXAMPLES = [
  {
    ...
    imageUrl:
      'https://lms.example.com/asset-v1:ROBBO+C4+November+type@asset+block@WLmgY3KijMg1.jpg',
    aboutUrl: 'https://lms.example.com/courses/course-v1:ROBBO+C4+November/about',
  },
  {
    ...
    imageUrl:
      'https://lms.example.com/asset-v1:Robbo+AC002+June+type@asset+block@%D0%97%D0%90%D0%A1%D0%A2%D0%90%D0%92%D0%9A%D0%90.jpg',
    aboutUrl: 'https://lms.example.com/courses/course-v1:Robbo+AC002+June/about',
  },
]
  ...
  const galleryItems = useMemo(
    () =>
      pickOfficial(3).map((file, idx) => ({
        file,
        url: `https://scratch.example.com/example${idx + 1}`,
      })),
    [],
  )
      ...
      <Main id='content'>
        <ContentWrap>
          <SectionCard {...sectionReveal}>
            <HeroInner>
              <div>
                ...
                <HeroLede>
                  Профиль, обучение в LMS, Scratch-проекты на scratch.example.com и единый
          ...
          <SectionCard {...sectionReveal}>
            ...
            <CtaBtn href='https://scratch.example.com/' target='_blank'
rel='noreferrer'>
          ...
          <SectionCard {...sectionReveal}>
            ...
            <StepStack>
              ...
              <StepRow>
                ...
                Нажмите «LMS» в меню — откроется платформа lms.example.com с
            ...
            <CtaRow>
              ...
              <CtaGhost href='https://lms.example.com' target='_blank'
rel='noreferrer'>
                Открыть LMS
              </CtaGhost>
...
rel='noreferrer'>
            ...
            <CtaBtn
              href='https://lms.example.com/courses/course-v1:Robbo+AC002+June/about'
              target='_blank'
              rel='noreferrer'
            >
